...
DIV.scott a.disabled {
 ...
 <div class=\"scott\"  style='color:#000000;'>
    共&nbsp;&nbsp;".$pageCount."&nbsp;&nbsp;&nbsp;页&nbsp;&nbsp;当前&nbsp;&nbsp;".$curPage."&nbsp;&nbsp;页&nbsp;&nbsp;&nbsp;";
  $curPage!=1?$pageStr.="<a href=?curPage=1&$pagePara&$pageid> < < </a><a href=?curPage=1&$pagePara&$pageid> < </a>":$pageStr.="<a href='javascript:void(0);'> < < </a><a href='javascript:void(0);'> < </a>";
 for($i=$pageFromNum;$i<=$pageToNum;$i++){
	$curPage==$i ? $pageStr.="<a class='current'>$i</a>" : 
	$pageStr.="<a href=?curPage=$i&$pagePara&$pageid>$i</a>";
  }  
	$curPage!=$pageCount ? $pageStr.="<a href=?curPage=$nextPage&$pagePara&$pageid> > </a><a href=?curPage=$pageCount&$pagePara&$pageid> > > </a>" : 
