...
<DIV class="tagContent selectTag" id=tagContent0>
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
    ...
    <tr>
      <td width="120" align="right" bgcolor="#FFFFFF"><strong>作品名称：</strong></td>
...
<?php
	...
	if($act == 'add')
	{
		...
		$sql = "INSERT INTO cnly_content(cat_id,news_title,news_desc,news_content,add_time,img_thumb,news_url,type,news_order,small_img,laiyuan,fbr,qq) 
						VALUES('$cat_id','$news_title','$news_desc','$news_content','$add_time','$img_thumb','$news_url','1','$news_order','$small_img','$laiyuan','$fbr','$qq')";
		
		if($db->query($sql))
		{
			
			urlMsg('添加成功','gat_list.php');
		}
		else
		{
			goBakMsg("添加失败");	
