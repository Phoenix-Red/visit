...
<DIV class="tagContent selectTag" id=tagContent0>
  ...
  <tr>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><input name="fbr" type="text" style="width:550px;" class="inputuser" onBlur="this.className='inputuser'" id="fbr" value="<?=@$row['fbr']?>" ><span style="color:#FF0000;">（每个选项之间用,号隔开）</span>      </td>
    </tr>
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>答案：</strong></td>
      <td bgcolor="#FFFFFF"><input name="laiyuan" type="text" style="width:450px; height:100px;" class="inputuser" onBlur="this.className='inputuser'" id="laiyuan" value="<?=@$row['laiyuan']?>" ><span style="color:#FF0000;">（填空题每个答案之间用,号隔开）</span>      </td>
    </tr>
    <tr>
...
<?php
	if($act == 'update')
	{
		...
		$url = "lx_list.php?curPage=".$curPage;
		if($db->query($sql))
		{
