  ...
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><select name="cat_id" id="select">
        <option value="" selected>请选择信息分类</option>
        <?php
                    sub_class(485,"");
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><select name="laiyuan" id="laiyuan" >
          ...
          <option value="3">长安区</option>
          <option value="4">雁塔区</option>
          <option value="5">碑林区</option>
          <option value="6">莲湖区</option>
                        </select></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><label>
        <input name="radio" type="radio" id="radio" value="0" checked>
      进行中&nbsp;&nbsp;&nbsp; 
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><label>
        <input name="sex" type="radio" id="radio3" value="0" checked>
        男&nbsp;&nbsp;&nbsp;
        <input type="radio" name="sex" id="radio4" value="1">
        女 </label></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><input name="news_order2" type="text" style="width:100px;" class="inputuser" onBlur="this.className='inputuser'" value=""></td>
    </tr>
    <tr>
...
<?php
	...
	if($act == 'add')
	{
		...
		$sql = "INSERT INTO cnly_content(cat_id,laiyuan,news_title,news_desc,news_content,add_time,img_thumb,news_url,type,news_order,small_img,file_url,news_src,tuijian,brand_id,new) 
						VALUES('$cat_id','$laiyuan','$news_title','$news_desc','$news_content','$add_time','$img_thumb','$news_url','$type','$news_order','$small_img','$file_url','$news_src','$tuijian','$brand_id','$new')";
		
		if($db->query($sql))
		{
			
			urlMsg('添加成功','qy_list.php');
		}
		else
		{
			goBakMsg("添加失败");	
