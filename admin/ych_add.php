...
<DIV class="tagContent selectTag" id=tagContent0>
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><input name="fbr" type="text" style="width:650px;" class="inputuser" onBlur="this.className='inputuser'" id="fbr" >      </td>
    </tr>
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>来源：</strong></td>
      <td bgcolor="#FFFFFF"><input name="laiyuan" type="text" style="width:450px;" class="inputuser" onBlur="this.className='inputuser'" id="laiyuan" >      </td>
    </tr>
    <tr>
...
<?php
	...
	if($act == 'add')
	{
		...
		$sql = "INSERT INTO cnly_content(cat_id,news_title,news_desc,news_content,add_time,img_thumb,news_url,type,news_order,small_img,laiyuan,fbr,zhuanye,zhiwei,danwei) 
						VALUES('$cat_id','$news_title','$news_desc','$news_content','$add_time','$img_thumb','$news_url','1','$news_order','$small_img','$laiyuan','$fbr','$zhuanye','$zhiwei','$danwei')";
		
		if($db->query($sql))
		{
			
			urlMsg('添加成功','ych_list.php');
		}
		else
		{
			goBakMsg("添加失败");	
