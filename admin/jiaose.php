...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px solid #B7E6B0;border-right:1px solid #B7E6B0;">
  <tr>
    <td height="30" background="images/main_title_bg.jpg">&nbsp;&nbsp;您的当前位置：<a href="#">系统首页</a> > 角色列表</td>
  </tr>
  <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="0" bgcolor="#D2FFD2" style="border:1px solid #BCE8B5">
            ...
            <tr>
              <td align="right"><table width="70" height="22" border="0" cellpadding="0" cellspacing="0" bgcolor="#009900" onMouseOver="this.style.backgroundColor='#003300';" onMouseOut="this.style.backgroundColor='#009900';">
                <tr>
                  ...
                  <td align="center"><p style="margin-top:3px"><a href="jiaose_add.php" style="font-size:12px; font-weight:normal; color:#FFFFFF; cursor:hand">增加角色</a></p></td>
                  </tr>
              </table></td>
              </tr>
          </form>
          ...
          <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#BCE8B5">
            <tr>
              ...
              <td align="center" background="images/list_title_bg.jpg"><strong>角色名称</strong></td>
              <td width="60" align="center" background="images/list_title_bg.jpg"><strong>操作</strong></td>
            </tr>
<?php
	$sql = "SELECT * FROM cnly_jiaose ORDER BY id";
	$res = $db->query($sql);
	$i = 1;
...
?>
            <tr <?=$style?>>
              ...
              <td align="center"><table width="60" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center"><a href="jiaose_upd.php?id=<?=$row['id']?>"><img src="images/icon_edit.gif" width="16" height="16" border="0" alt="修改"></a></td>
                  <td align="center">
...
<?php
	...
	if($act == 'del')
	{
		...
		$sql = "DELETE FROM cnly_jiaose WHERE id='$id'";
		$db->query($sql);
		urlMsg('删除成功','jiaose.php');
