...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px solid #B7E6B0;border-right:1px solid #B7E6B0;">
  <tr>
    <td height="30" background="images/main_title_bg.jpg">&nbsp;&nbsp;您的当前位置：<a href="#">系统首页</a> > 角色添加</td>
  </tr>
  <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="0" bgcolor="#D2FFD2" style="border:1px solid #BCE8B5">
          ...
          <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#BCE8B5">
            ...
            <tr>
              ...
              <td align="left" bgcolor="#FFFFFF" ><input type="text" name="jiaosename" id="jiaosename"></td>
              </tr>
            <tr>
  ...
  <tr>
    <td width="120" height="30"><?=$row['name']?><input type="checkbox" name="left[]" value="<?=$row['id']?>"></td>
  </tr>
</table>
...
?>   
                    <TR align=middle <?=$style?>>
                      ...
                      <TD align="center"><A href="chadangyuyue.php" target="main-frame">
                        <input type="checkbox" name="qx[]" value="<?=$row['id']?>">
                      </A></TD>
                      </TR>
                    <?php
...
<?php
	...
	if($act == 'add')
	{
		...
		$sql = "insert into cnly_jiaose(jiaose_name,jiaose_quanxian,jiaose_left) values('$jiaosename','$qx','$left')";
		
		if($db->query($sql))
		{
			echo "<script>alert('添加成功');window.location='jiaose.php'</script>";
		}
