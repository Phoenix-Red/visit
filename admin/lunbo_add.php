...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px solid #B7E6B0;border-right:1px solid #B7E6B0;">
  <tr>
    <td height="30" background="images/main_title_bg.jpg">&nbsp;&nbsp;您的当前位置：<a href="#">系统首页</a> > 添加图片</td>
  </tr>
  <tr>
          ...
          <tr>
            <td align="right"><table width="70" height="22" border="0" cellpadding="0" cellspacing="0" bgcolor="#009900" onMouseOver="this.style.backgroundColor='#003300';" onMouseOut="this.style.backgroundColor='#009900';">
              <tr>
                ...
                <td align="center"><p style="margin-top:3px"><a href="lunbo_list.php" style="font-size:12px; font-weight:normal; color:#FFFFFF">图片列表</a></p></td>
                </tr>
            </table></td>
          </tr>
        </table>
...
<DIV class="tagContent selectTag" id=tagContent0>
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
    ...
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>轮播分类：</strong></td>
    ...
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>图片缩略图：</strong></td>
...
<?php
	...
	if($act == 'add')
	{
		...
		$sql = "INSERT INTO cnly_content(cat_id,news_title,news_desc,news_content,add_time,img_thumb,news_url,type,news_order,small_img) 
		...
		if($cat_id==251)
		{
				 ...
				 $sql = "SELECT * FROM cnly_content   WHERE img_thumb!=''  and cat_id in(251) ORDER BY  add_time DESC LIMIT 0,6";
						...
						$dd.="<item item_url=\"".$row['img_thumb']."\" link=\"".$row['tu_url']."\" itemtitle=\"".$row['news_title']."\" />\r\n";
						}
