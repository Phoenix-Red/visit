...
<DIV class="tagContent selectTag" id=tagContent0>
  ...
  <tr>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><input name="fbr" type="text" style="width:650px;" class="inputuser" onBlur="this.className='inputuser'" id="fbr" value="<?=@$row['fbr']?>" >
      </td>
    </tr>
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>来源：</strong></td>
      <td bgcolor="#FFFFFF"><input name="laiyuan" class="inputuser" id="laiyuan"  style="width:350px;" value="<?=@$row['laiyuan']?>" onBlur="this.className='inputuser'">
      </td>
    </tr>
    <tr>
...
<?php
	if($act == 'update')
	{
		...
		$url = "zt_list.php?curPage=".$curPage;
		if($db->query($sql))
		{
			urlMsg('修改成功',$url);
		}
