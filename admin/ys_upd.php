...
<DIV class="tagContent selectTag" id=tagContent0>
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
    <tr>
      <td width="135" align="right" bgcolor="#FFFFFF"><strong>信息标题：</strong></td>
      <td width="914" bgcolor="#FFFFFF"><input name="news_title" type="text" style="width:450px;" class="inputuser" onBlur="this.className='inputuser'" onFocus="this.className='inputuser-bor'" value="<?=@$row['news_title']?>"></td>
      </tr>
    <tr>
...
<?php
	if($act == 'update')
	{
		...
		$url = "ys_list.php?curPage=".$curPage;
		if($db->query($sql))
		{
