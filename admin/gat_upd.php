          ...
          <tr>
            <td align="right"><table width="70" height="22" border="0" cellpadding="0" cellspacing="0" bgcolor="#009900" onMouseOver="this.style.backgroundColor='#003300';" onMouseOut="this.style.backgroundColor='#009900';">
              <tr>
                ...
                <td align="center"><p style="margin-top:3px"><a href="gat_list.php" style="font-size:12px; font-weight:normal; color:#FFFFFF">信息列表</a></p></td>
                </tr>
            </table></td>
          </tr>
        </table>
...
<DIV class="tagContent selectTag" id=tagContent0>
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
    <tr>
      <td width="120" align="right" bgcolor="#FFFFFF"><strong>姓名：</strong></td>
  ...
  <tr>
    ...
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>职务：</strong></td>
      <td bgcolor="#FFFFFF"><input name="fbr" type="text" style="width:450px;" class="inputuser" onBlur="this.className='inputuser'" id="fbr" value="<?=@$row['fbr']?>" >      </td>
    </tr>
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>学历：</strong></td>
      <td bgcolor="#FFFFFF"><input name="laiyuan" type="text" style="width:450px;" class="inputuser" onBlur="this.className='inputuser'" id="laiyuan" value="<?=@$row['laiyuan']?>" >      </td>
    </tr>
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>QQ：</strong></td>
      <td bgcolor="#FFFFFF"><input name="qq" type="text" style="width:450px;" class="inputuser" onBlur="this.className='inputuser'" id="qq" value="<?=@$row['qq']?>" >
      </td>
    </tr>
    <tr>
...
<?php
	if($act == 'update')
	{
		...
		if(!empty($img_thumb))
		{	
			$sql = "UPDATE cnly_content SET cat_id='$cat_id',news_title='$news_title',news_desc='$news_desc',news_content='$news_content',add_time='$add_time',img_thumb='$img_thumb',small_img ='$small_img ',news_url='$news_url',news_order='$news_order',laiyuan='$laiyuan',fbr='$fbr',qq='$qq' WHERE id='$id'";
		}
		else
		{
			$sql = "UPDATE cnly_content SET cat_id='$cat_id',news_title='$news_title',news_desc='$news_desc',news_content='$news_content',add_time='$add_time',news_url='$news_url',news_order='$news_order',laiyuan='$laiyuan',fbr='$fbr',qq='$qq' WHERE id='$id'";
		}
		$url = "gat_list.php?curPage=".$curPage;
		if($db->query($sql))
		{
