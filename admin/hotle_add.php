...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px solid #B7E6B0;border-right:1px solid #B7E6B0;">
  <tr>
    <td height="30" background="images/main_title_bg.jpg">&nbsp;&nbsp;您的当前位置：<a href="#">系统首页</a> > 添加酒店信息</td>
  </tr>
  <tr>
          ...
          <tr>
            <td align="right"><table width="70" height="22" border="0" cellpadding="0" cellspacing="0" bgcolor="#009900" onMouseOver="this.style.backgroundColor='#003300';" onMouseOut="this.style.backgroundColor='#009900';">
              <tr>
                ...
                <td align="center"><p style="margin-top:3px"><a href="hotle_list.php" style="font-size:12px; font-weight:normal; color:#FFFFFF">酒店列表</a></p></td>
                </tr>
            </table></td>
          </tr>
        </table>
...
<DIV class="tagContent selectTag" id=tagContent0>
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
    ...
    <tr>
      <td width="120" align="right" bgcolor="#FFFFFF"><strong>酒店名称：</strong></td>
    ...
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>酒店地址：</strong></td>
      <td bgcolor="#FFFFFF"><input name="address" type="text" style="width:450px;" class="inputuser" onBlur="this.className='inputuser'" onFocus="this.className='inputuser-bor'"></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>酒店分类：</strong></td>
      <td bgcolor="#FFFFFF"><select name="cat_id" id="select">
        <option value="">请选择酒店分类</option>
        <?php
                    sub_class(140,"");
    ...
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>酒店缩略图：</strong></td>
      <td bgcolor="#FFFFFF"><input type="file" name="img_thumb" id="img_thumb"></td>
      </tr>
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>酒店价格：</strong></td>
      <td bgcolor="#FFFFFF"><input name="price" type="text" style="width:450px;" class="inputuser" onBlur="this.className='inputuser'" onFocus="this.className='inputuser-bor'" value=""></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>预定电话：</strong></td>
      <td bgcolor="#FFFFFF"><input name="news_url" type="text" style="width:450px;" class="inputuser" onBlur="this.className='inputuser'" onFocus="this.className='inputuser-bor'" value=""></td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>酒店简介：</strong></td>
...
function selectTag(showContent,selfObj){
  ...
  <tr>
    <td align="center" height="25">
          <center>
            <a href="http://www.xadade.com" target="_blank">技术支持：西安大德网络科技有限公司 电话：029-85368586</a>
          </center></td>
  </tr>
</table>
<?php
	...
	if($act == 'add')
	{
		...
		$sql = "INSERT INTO cnly_content(cat_id,price,address,news_title,news_desc,news_content,add_time,img_thumb,news_url,type,news_order,small_img) 
						VALUES('$cat_id','$price','$address','$news_title','$news_desc','$news_content','$add_time','$img_thumb','$news_url','1','$news_order','$small_img')";
		
		if($db->query($sql))
		{

				urlMsg('添加成功','hotle_list.php');
