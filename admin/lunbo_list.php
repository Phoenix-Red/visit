...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px solid #B7E6B0;border-right:1px solid #B7E6B0;">
  <tr>
    <td height="30" background="images/main_title_bg.jpg">&nbsp;&nbsp;您的当前位置：<a href="#">系统首页</a> >图片轮播管理</td>
  </tr>
  <tr>
        ...
        <option value="">请选择产品分类</option>
              ...
              <td width="80" align="right"><table width="70" height="22" border="0" cellpadding="0" cellspacing="0" bgcolor="#009900" onMouseOver="this.style.backgroundColor='#003300';" onMouseOut="this.style.backgroundColor='#009900';">
                  <tr>
                    ...
                    <td align="center"><p style="margin-top:3px"><a href="lunbo_add.php" style="font-size:12px; font-weight:normal; color:#FFFFFF">添加图片</a></p></td>
                  </tr>
              </table></td>
            </tr></form>
          </table>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#BCE8B5">
            <tr>
              ...
              <td align="center" background="images/list_title_bg.jpg"><strong>名称</strong></td>
...
$countSql="SELECT a.id FROM cnly_content AS a,cnly_class AS b WHERE a.cat_id=b.id $sqlwhere AND b.type='lunbo'";//sql语句
...
$sql = "SELECT a.id AS id,news_title,class_name,add_time,news_order,img_thumb FROM cnly_content AS a,cnly_class AS b WHERE a.cat_id=b.id $sqlwhere  AND b.type='lunbo' ORDER BY news_order ASC,add_time DESC LIMIT $rsStart, $pageSize";
$res = $db->query($sql);
$i = 1;
...
?>            
            <tr <?=$style?>>
              ...
              <td align="center"><table width="60" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center">
                  <a href="lunbo_upd.php?act=upd&id=<?=$row['id']?>&curPage=<?=$curPage?>&<?=$KeyWord?>">
