...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px solid #B7E6B0;border-right:1px solid #B7E6B0;">
  <tr>
    <td height="30" background="images/main_title_bg.jpg">&nbsp;&nbsp;您的当前位置：<a href="#">系统首页</a> >友情链接</td>
  </tr>
  <tr>
          ...
          <tr>
              ...
              <td width="80" align="right"><table width="70" height="22" border="0" cellpadding="0" cellspacing="0" bgcolor="#009900" onMouseOver="this.style.backgroundColor='#003300';" onMouseOut="this.style.backgroundColor='#009900';">
                  <tr>
                    ...
                    <td align="center"><p style="margin-top:3px"><a href="friendly_add.php" style="font-size:12px; font-weight:normal; color:#FFFFFF">添加连接</a></p></td>
                  </tr>
              </table></td>
            </tr>
          </table>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#BCE8B5">
            <tr>
              ...
              <td align="center" background="images/list_title_bg.jpg"><strong>链接标题</strong></td>
              <td width="100" align="center" background="images/list_title_bg.jpg"><strong>链接分类</strong></td>
              <td width="200" align="center" background="images/list_title_bg.jpg"><strong>链接地址</strong></td>
              <td width="60" align="center" background="images/list_title_bg.jpg"><strong>操作</strong></td>
            </tr>
<?php

$countSql="SELECT a.id FROM cnly_content AS a,cnly_class AS b WHERE a.cat_id=b.id AND b.type='yqgl'";//sql语句
$KeyWord = "";
$pageSize="20"; //每页显示数
...
$sql = "SELECT a.id AS id,news_title,class_name,add_time FROM cnly_content AS a,cnly_class AS b WHERE a.cat_id=b.id  AND b.type='yqgl' ORDER BY add_time DESC LIMIT $rsStart, $pageSize";
$res = $db->query($sql);
$i = 1;
            ...
            <tr <?=$style?>>
              ...
              <td align="center"><table width="60" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td align="center">
                  <a href="friendly_upd.php?act=upd&id=<?=$row['id']?>&curPage=<?=$curPage?>&<?=$KeyWord?>">
...
$url = "friendly_list.php?curPage=".$curPage."&".$urlPara."";
if($act == 'del'){
