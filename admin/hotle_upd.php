...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px solid #B7E6B0;border-right:1px solid #B7E6B0;">
  <tr>
    <td height="30" background="images/main_title_bg.jpg">&nbsp;&nbsp;您的当前位置：<a href="#">系统首页</a> >旅游信息修改</td>
  </tr>
  <tr>
...
<DIV class="tagContent selectTag" id=tagContent0>
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><input name="address" type="text" style="width:450px;" class="inputuser" onBlur="this.className='inputuser'" onFocus="this.className='inputuser-bor'" value="<?=@$row['address']?>"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><input name="price" type="text" style="width:450px;" class="inputuser" onBlur="this.className='inputuser'" onFocus="this.className='inputuser-bor'" value="<?=@$row['price']?>"></td>
    </tr>
    <tr>
...
<?php
	...
	if($act == 'update')
	{
		...
		if(!empty($img_thumb))
		{	
			$sql = "UPDATE cnly_content SET cat_id='$cat_id',address='$address',price='$price',news_title='$news_title',news_desc='$news_desc',news_content='$news_content',add_time='$add_time',img_thumb='$img_thumb',small_img ='$small_img ',news_url='$news_url',news_order='$news_order' WHERE id='$id'";
		}
		else
		{
			$sql = "UPDATE cnly_content SET cat_id='$cat_id',address='$address',price='$price',news_title='$news_title',news_desc='$news_desc',news_content='$news_content',add_time='$add_time',news_url='$news_url',news_order='$news_order' WHERE id='$id'";
		}
		$url = "hotle_list.php?curPage=".$curPage;
