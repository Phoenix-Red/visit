        ...
        <option value="">请选择信息分类</option>
              ...
              <td width="80" align="right"><table width="70" height="22" border="0" cellpadding="0" cellspacing="0" bgcolor="#009900" onMouseOver="this.style.backgroundColor='#003300';" onMouseOut="this.style.backgroundColor='#009900';">
                  <tr>
                    ...
                    <td align="center"><p style="margin-top:3px"><a href="bt_add.php" style="font-size:12px; font-weight:normal; color:#FFFFFF">添加信息</a></p></td>
                  </tr>
              </table></td>
            </tr></form>
          </table>
...
$countSql="SELECT a.id FROM cnly_content AS a,cnly_class AS b WHERE a.cat_id=b.id  $sqlwhere  AND b.type='shbt'";//sql语句
...
$sql = "SELECT a.id AS id,news_title,class_name,add_time,news_order,img_thumb FROM cnly_content AS a,cnly_class AS b WHERE a.cat_id=b.id  $sqlwhere  AND b.type='shbt' ORDER BY news_order ASC,add_time DESC LIMIT $rsStart, $pageSize";
$res = $db->query($sql);
$i = 1;
while($row = $db->getarray($res))
{
            ...
            <tr <?=$style?>>
              ...
              <td align="center"><table width="60" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center">&nbsp;</td>
                  <td align="center">
                    <a href="bt_upd.php?act=upd&id=<?=$row['id']?>&curPage=<?=$curPage?>&<?=$KeyWord?>">
...
$url = "bt_list.php?curPage=".$curPage."&".$urlPara."";
if($act == 'del'){
