...
$id=mysql_insert_id();
	...
	{
	echo "<script>alert('添加成功！');location.href='user_add.php?id=".$id."&act=look'</script>";	
	
	}
	else
	{
	echo "<script>alert('添加成功！');location.href='user_list.php'</script>";	
	}
}
}
?>
