...
DIV.scott A {
	BORDER-RIGHT: #6E6E6E 1px solid; PADDING-RIGHT: 5px; BORDER-TOP: #6E6E6E 1px solid; PADDING-LEFT: 5px; PADDING-BOTTOM: 2px; BORDER-LEFT: #6E6E6E 1px solid; COLOR: #f4f4f4; BACKGROUND-COLOR: #000000; MARGIN-RIGHT: 2px; PADDING-TOP: 2px; BORDER-BOTTOM: #6E6E6E 1px solid; TEXT-DECORATION: none
}
DIV.scott A:hover {
	BORDER-RIGHT: #85bd1e 1px solid; BORDER-TOP: #85bd1e 1px solid; BORDER-LEFT: #85bd1e 1px solid; COLOR: #f4f4f4; BORDER-BOTTOM: #85bd1e 1px solid; BACKGROUND-COLOR: #c69401
}
DIV.scott A:active {
	BORDER-RIGHT: #85bd1e 1px solid; BORDER-TOP: #85bd1e 1px solid; BORDER-LEFT: #85bd1e 1px solid; COLOR: #f4f4f4; BORDER-BOTTOM: #85bd1e 1px solid; BACKGROUND-COLOR: #FFC001
}
DIV.scott SPAN.current {
	BORDER-RIGHT: #b2e05d 1px solid; PADDING-RIGHT: 5px; BORDER-TOP: #b2e05d 1px solid; PADDING-LEFT: 5px; FONT-WEIGHT: bold; PADDING-BOTTOM: 2px; BORDER-LEFT: #b2e05d 1px solid; COLOR: #000000; MARGIN-RIGHT: 2px; PADDING-TOP: 2px; BORDER-BOTTOM: #b2e05d 1px solid; BACKGROUND-COLOR: #f4f4f4
}
DIV.scott SPAN.disabled {
 ...
 <div class=\"scott\">
  ...
  $curPage!=1?$pageStr.="<a href=?curPage=1&$pagePara> < < </a><a href=?curPage=1&$pagePara> < </a>":$pageStr.="<a href='javascript:void(0);'> < < </a><a href='javascript:void(0);'> < </a>";
 for($i=$pageFromNum;$i<=$pageToNum;$i++){
	$curPage==$i ? $pageStr.="<span class='current'>$i</span>" : 
	$pageStr.="<a href=?curPage=$i&$pagePara>$i</a>";
  }  
	$curPage!=$pageCount ? $pageStr.="<a href=?curPage=$nextPage&$pagePara> > </a><a href=?curPage=$pageCount&$pagePara> > > </a>" : 
	$pageStr.="<a href='javascript:void(0);'> > </a><a href='javascript:void(0);'> > > </a>";
 $pageStr.="</div>";
