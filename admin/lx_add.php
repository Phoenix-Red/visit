          ...
          <tr>
            <td align="right"><table width="70" height="22" border="0" cellpadding="0" cellspacing="0" bgcolor="#009900" onMouseOver="this.style.backgroundColor='#003300';" onMouseOut="this.style.backgroundColor='#009900';">
              <tr>
                ...
                <td align="center"><p style="margin-top:3px"><a href="lx_list.php" style="font-size:12px; font-weight:normal; color:#FFFFFF">信息列表</a></p></td>
                </tr>
            </table></td>
          </tr>
        </table>
...
<DIV class="tagContent selectTag" id=tagContent0>
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
    ...
    <tr>
      <td width="120" align="right" bgcolor="#FFFFFF"><strong>题目：</strong></td>
    ...
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>选择题选项：</strong></td>
      <td bgcolor="#FFFFFF"><input name="fbr" type="text" style="width:550px;" class="inputuser" onBlur="this.className='inputuser'" id="fbr" >
      <span style="color:#FF0000;">（每个选项之间用,号隔开）</span>
      </td>
    </tr>
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>答案：</strong></td>
      <td bgcolor="#FFFFFF"><input name="laiyuan" type="text" style="width:450px; height:100px;" class="inputuser" onBlur="this.className='inputuser'" id="laiyuan" > <span style="color:#FF0000;">（填空题每个答案之间用,号隔开）</span>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>链接：</strong></td>
    ...
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>简介：</strong></td>
...
<?php
	...
	if($act == 'add')
	{
		...
		$sql = "INSERT INTO cnly_content(cat_id,news_title,news_desc,news_content,add_time,img_thumb,news_url,type,news_order,small_img,laiyuan,fbr) 
						VALUES('$cat_id','$news_title','$news_desc','$news_content','$add_time','$img_thumb','$news_url','1','$news_order','$small_img','$laiyuan','$fbr')";
		
		if($db->query($sql))
		{
			
			urlMsg('添加成功','lx_list.php');
		}
		else
		{
			goBakMsg("添加失败");	
